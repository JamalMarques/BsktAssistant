 ...
 */
public class DBRobos{

    //Nombre de la tabla
    private static final String TABLE_NAME = "Robos";
    ...
    public DBRobos(Context context){
    ...
    public List<Robo> ListaRob_jugador_partido(int jug_id,int part_id){
